...
- Screenshots: `.temp/page-screenshot.png`
- Snapshots: `.temp/page-snapshot.yml`
- Console logs: `.temp/console-output.log`

This keeps the repository root clean and prevents accidental commits of generated files.
